...
if test -x PerlMagick -a -f Makefile.aperl ; then
  ...
  ${MAKE} -f Makefile.aperl CC='/home/simon/GIT/buildroot-k3-current/output/host/usr/bin/arm-none-linux-gnueabi-gcc -std=gnu99 -std=gnu99' TEST_VERBOSE=1 test
elif test -f Makefile -a -f Magick.o; then
  # Shared build test incantation
  ${MAKE} CC='/home/simon/GIT/buildroot-k3-current/output/host/usr/bin/arm-none-linux-gnueabi-gcc -std=gnu99 -std=gnu99' TEST_VERBOSE=1 test
else
